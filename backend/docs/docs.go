            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.chatHistoryResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.VehicleDashboard"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/vehicles/{id}/events": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.vehicleEventsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Vehicle event payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.vehicleEventRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/vehicles/{id}/events/{eventId}": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Vehicle event patch payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.vehicleEventUpdateRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.vehicleTimelineResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        "domain.ChatMessage": {
            ...
            "properties": {
                ...
                "role": {
                    "$ref": "#/definitions/domain.ChatRole"
                },
                "user_id": {
                    "type": "integer"
                },
        ...
        "domain.DashboardPredictionSummary": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
        ...
        "domain.DashboardVehicleSummary": {
            "type": "object",
            "properties": {
                "brand": {
                    "type": "string"
        ...
        "domain.Prediction": {
            ...
            "properties": {
                ...
                "source": {
                    "$ref": "#/definitions/domain.PredictionSource"
                },
                "vehicle_id": {
                    "type": "integer"
                }
        ...
        "domain.PredictionSource": {
            ...
            "x-enum-varnames": [
                "PredictionSourceRuleBased",
                "PredictionSourceMock",
                "PredictionSourceMLService"
            ]
        },
        "domain.RiskLevel": {
            "type": "string",
        ...
        "domain.VehicleDashboard": {
            ...
            "properties": {
                ...
                "latest_events": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.DashboardEventPreview"
                    }
                },
                "prediction_summary": {
                ...
                "vehicle": {
                    "$ref": "#/definitions/domain.DashboardVehicleSummary"
                }
            }
        },
        "domain.VehicleEvent": {
        ...
        "handler.chatRequest": {
            ...
            "properties": {
                "message": {
                    "type": "string",
                    "example": "Когда мне нужно менять масло?"
                }
            }
        },
